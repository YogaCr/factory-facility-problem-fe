<template>
  <form @submit.prevent="submitForm">
    <div class="flex flex-col">
      ...
      <input type="number" name="gap" id="gap" step="any" v-model="gap" class="bg-transparent dark:border border-white rounded p-2 my-4" min="0">
    ...
    <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white py-2 px-4 rounded" v-if="!isLoading" style="height:fit-content">Upload</button>
